										...
										success: function (res) {
											...
											function sumitImageFile(base64Codes) {
												...
												$.ajax({
													...
													success: function (data) {
														imgurl = data.data[0];
														var _str = "<img src=" + imgurl + "  id='chose_pic_btns' style='margin-top:0;'/>"
					...
					for(var k = 0; k < data.productFile.length; k++) {						
						if(data.productFile[k].type == '2') {
							imgdiv = data.productFile[k].url;
								_strv += '<span class="pic_look2" style="width: 30%; height: 2.08rem; display: inline-block; background-size: cover; background-position: center center; background-repeat: no-repeat; box-sizing: border-box; margin-left: 3.3333%; margin-bottom: 12px; position: relative;">'
					...
					for(var k = 0; k < data.productFile.length; k++) {						
						if(data.productFile[k].type == '3') {
							imgdiv1 = data.productFile[k].url;
								_strx += '<span class="pic_look1" style="width: 30%; height: 2.08rem; display: inline-block; background-size: cover; background-position: center center; background-repeat: no-repeat; box-sizing: border-box; margin-left: 3.3333%; margin-bottom: 12px; position: relative;">'
									+		'<img class="pic_looka" src="'+data.productFile[k].url+'"/>'
									+		'<em id="delete_pic" style="position: absolute; display: inline-block; width: 25px; height: 25px; background-color: #ff0000; color: #fff; font-size: 18px; right: 5px; top: 5px; text-align: center; line-height: 22px; border-radius: 50%; font-weight: bold;">-</em>'
									+	'</span>'
								a++;	
...
//					goodtype = 7;
//				}
//				if (!goodtype || !imgurls || !beginPrice || !nowPrice || !title) {
//					layer.msg('请完善信息');
//				} else {
//					$.ajax({
//						type: "post",
//						url: global + "/product/updateProduct",
//						async: true,
//						data: {
//							"tokenKey": tokenKey,
//							"id": goodsId, //商品id

...
(function (global, factory) {
    typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory() : typeof define === "function" && define.amd ? (function () {
    ...
    var ___ = window;
    //模板
    var $template = "<span class=\"active-time pull-right\"><t class='time_prefix'></t><em class=\"time_m\"></em>:<em class=\"time_s\"></em><t class='time_suffix'></span>";
    ...
    var fns = {
        ...
        _title: function () {
            var _opts = this.opts;
            var $prefix = this.$timeEms_.$prefix,
                $suffix = this.$timeEms_.$suffix;

$(function () {
	//	var tokenKey = '743921d997244b76a07a3fc6e6be39831542590571217';
	//var tokenKey = 'b11c18c0c95e4bb8be877c252ff314781542339024675';
	// 获取openId
	...
	var shop = {
		...
		submitForm: function () {
			...
			$('.submit').click(function () {
				...
				if (!starNum) {
					layer.msg('请对验光师服务态度进行评价');
					return false;
				}
				if (!starNuma) {
					layer.msg('请对验光师专业技术进行评价');
					return false;
				}
				if (!commentContent) {
					layer.msg('请输入评价');
				...
				$.ajax({
					...
					success: function (data) {
						...
						if (data.code == 200) {
							...
							location.href = 'optometrist_detail.html?shopId=' + shopId + '&id=' + infoId;
